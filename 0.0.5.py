...
║                 {Fore.RED}Alpha {Fore.GREEN}Version 0.0.5{Fore.CYAN}                           ║
║              {Fore.CYAN}Build: {Fore.YELLOW}  may,  30, 2026{Fore.CYAN}                          ║
...
def decrypt_dpa(dpa_path: str, key: str = None) -> str:
    ...
    if header == DPA_HEADER_PLAIN:
        return body
    if header == DPA_HEADER_XOR:
        encoded = "".join(body.split())  # remove all whitespace/newlines
...
def main():
    ...
    while True:
        ...
        # ---- VERSION ----
            ...
            print(Fore.WHITE + "Version:         " + Fore.GREEN + "0.0.5")
        ...
        # ---- DEBUG ----
            ...
            print(Fore.WHITE + "  System Name:    " + Fore.YELLOW + "DCMDS (Danrode CMD System)")
            print(Fore.WHITE + "  Version:        " + Fore.GREEN + "0.0.5 (Alpha)")
                ...
                if choice == "0":
                    ...
                    try:
                        ...
                        with open(filename, "w", encoding="utf-8") as f:
                            ...
                            f.write(f"DCMDS Version: 0.0.5 (Alpha)\n")
